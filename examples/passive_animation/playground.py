...
from playwindow import window, line, oval, rectangle, polygon, coords, move, sleep
...
for i in range(16):
    ...
    o = line(50, 50, 50 + 140 * math.sin(fi), 50 + 140 * math.cos(fi), fill='#ff0')
    rays.append(o)
...
while True:
    ...
    n += 1
    for i in range(16):
        fi = math.pi * 2 * i / 16 + n / 100.
        coords(rays[i], 50, 50, 50 + 140 * math.sin(fi), 50 + 140 * math.cos(fi))
